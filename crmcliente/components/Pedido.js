...
const Pedido = ({ pedido }) => {
    ...
    const [estadoPedido, setEstado] = useState(estado);
    ...
    const camabiarEstadodPedido = async nuevoEstado =>{
    ...
    return (
        <div className={`${clase} border-t-4 mt-4 bg-white rounded p-6 md:grid md:grid-cols-2 md:gap-4 shadow-lg`}>
            <div> 
                ...
                <select
                    className="mt-2 appearance-none bg-blue-600 border border-blue-600 text-white p-2 rounded text-center leading-tight focus:outline-none focus:bg-blue-600 focus:border-blue-300 uppercase text-xs font-bold"
                    defaultValue={estadoPedido}
                    onChange={e => camabiarEstadodPedido(e.target.value)}
                >
                    <option className="bg-blue-300" value="COMPLETADO">COMPLETADO</option>
                    <option className="bg-blue-300" value="PENDIENTE">PENDIENTE</option>
                    <option className="bg-blue-300" value="CANCELADO">CANCELADO</option>
                </select>
            </div>
            <div>
