...
const Sidebar = () => {
    ...
    return (
        // sm es para en un tamaño pequeño aplicar
        <aside className="bg-gray-800 sm:w-1/3 xl:w-1/5 sm:min-h-screen p-5">
            ...
            <nav className="mt-5 list-none">
                <li className={router.pathname === "/mejoresvendedores" ? "bg-blue-900 p-2" : "p-2"}>
                ...
                <li className={router.pathname === "/mejoresclientes" ? "bg-blue-900 p-2" : "p-2"}>
